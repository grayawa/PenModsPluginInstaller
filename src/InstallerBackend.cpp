...
void InstallerBackend::ensureDatabase()
{
    ...
    const QStringList statements = {
        ...
        QStringLiteral("INSERT OR IGNORE INTO installed_plugins (plugin_id, folder_name, installed_version, status, metadata_json) VALUES ('lyrecoul.penmods', 'PenMods', 'vmain', 'system', '{\"id\":\"lyrecoul.penmods\",\"kind\":\"core\",\"name\":\"PenMods\"}')"),
        ...
        QStringLiteral("UPDATE installed_plugins SET installed_version = 'vmain' WHERE plugin_id = 'lyrecoul.penmods' AND installed_version = 'main'")
    };
